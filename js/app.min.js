...
let slider_about = new Swiper('.product-card__images', {
...
//форматирование цены
(function() {
   let caseSumsToSep = document.querySelectorAll('.price');
   caseSumsToSep.forEach(makeNumSep);
   function makeNumSep(item, index) {
     let workValue = item.innerHTML;
     item.innerHTML = parseFloat(workValue).toLocaleString('ru-RU', {minimumFractionDigits: 0, maximumFractionDigits: 0}).replace(',', '.');
   }
 }) ();


//инициализация тултипов бутстрап
